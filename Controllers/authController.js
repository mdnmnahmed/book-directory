...
//we need to create a cookie for user when user signup or login
const createSendToken = (user, statusCode, res) => {
  ...
  const cookieOptions = {
    expires: new Date(
      ...
      //we need to convert days to milliseconds so we multiply with 24 hours, 60 minutes, 60 seconds and 1000 milliseconds and we need to convert it to integer value because we get float value from Date.now() method
    ),
    httpOnly: true,
  };
  ...
  //we need to remove password from output
